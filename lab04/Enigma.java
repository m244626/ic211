...
public class Enigma{
    ...
    */
    public String encrypt(String message){
        ...
        for (int i = 0; i < message.length(); i++){
            ...
            Rotor3.reverseByOne( Rotor2.reverseByOne( Rotor1.reverseByOne(true) ) ); 
        }
    ...
    */
    ...
    public static void main(String[] args){
        ...
        Enigma enigma = new Enigma(3, 1, 2, "SAT");
        
        //Prints Gears
        enigma.Rotor1.outputGear();
        enigma.Rotor2.outputGear();
        enigma.Rotor3.outputGear();

        // Encrypt
        System.out.println(enigma.encrypt("DO#YOUR#BEST#AND#KEEP#ON#KEEPIN#ON"));
    }   
}